...
```{r boxPlot, fig.cap="Figure 2. Volume of an open-top box from a 36x48 inch sheet of paper.", fig.alt="Line plot showing the volume of an open-top box as a function of height of the cut, x, for a 36x48 inch sheet of paper.", echo=FALSE}
